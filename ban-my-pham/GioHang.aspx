            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center">
                        <input type="button" value="-" onclick="javascript:__doPostBack('botSanPham', '<%= sp.sanPham.maSanPham %>');" />
                        <%=sp.soLuong %>
                        <input type="button" value="+" onclick="javascript:__doPostBack('themSanPham', '<%= sp.sanPham.maSanPham %>');" /></td>
                    <td><input type="button" value="Xóa" onclick="javascript:__doPostBack('xoaSanPham', '<%= sp.sanPham.maSanPham %>');" /></td>
                </tr>
                <% } %>
            </tbody>
        </table>
